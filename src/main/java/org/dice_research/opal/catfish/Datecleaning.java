...
/* 
 * Date cleaning is the progress of cleaning the dates which is not
 * in the correct format. According to DCAT Vocabulary,W3C has defined a 
 * standard date format "YYYY-MM-DD".
 * Here, we are checking different date formats in dct:issued property and
 * cleaning the dates accordingly. 
